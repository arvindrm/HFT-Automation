...
public class ResultsPage {
	...
	private By noSearchResult = By.xpath("//div[contains(@class,'heading__heading')]/h1");
	...
	public String getSearchPageTitle(String productName) {
		System.out.println("ResultsPage-SearchPageTitle: " + productName);
	...
	public String getSearchResultTxt() {
		return eleUtil.waitForElementPresence(noSearchResult, TimeUtil.LARGE_TIME_OUT).getText();
	}
}